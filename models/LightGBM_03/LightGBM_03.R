...
# train_f: 0.999221,  test_f: 0.9951    - baseline

# train_f: 0.9990983, test_f: 0.9949333 - 句点・読点の直前の品詞情報を追加
...
source("models/LightGBM_03/functions.R", encoding = "utf-8")
...
# })
# write_train_data(df.train, "models/LightGBM_03/data/input/train_data.csv")
